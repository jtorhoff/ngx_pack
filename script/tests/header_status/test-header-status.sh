...
# script/tests/header_status/fault_filter, and runs
# script/tests/header_status/test_header_status.py against it.
#
...
cd "$ROOT"
python3 script/tests/header_status/test_header_status.py "$BUILD/objs/nginx"
